...
<script>
  ...
  export default {
    ...
    data() {
      return {
        url: { list: '/system/sysPersonnel/list' },
        columns: [
          { title: '姓名', align: 'center', width: '25%', widthRight: '70%', dataIndex: 'name' },
          { title: '工号/警号', align: 'center', width: '25%', dataIndex: 'policeNo' },
