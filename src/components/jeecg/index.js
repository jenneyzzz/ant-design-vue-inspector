...
import ZSelectLinkage from './ZSelectLinkage'
//jeecgbiz
...
import JSelectPersonnel from '../jeecgbiz/JSelectPersonnel.vue'
//引入需要全局注册的js函数和变量
...
export default {
  install(Vue) {
    ...
    //二级联动
    Vue.component('ZSelectLinkage',ZSelectLinkage);
    ...
    Vue.component('JSelectPersonnel',JSelectPersonnel)
