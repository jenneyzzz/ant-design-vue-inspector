    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="登录账号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="username">
          <a-input placeholder="请输入登录账号" v-model="model.username" :readOnly="!!model.id"/>
        </a-form-model-item>
...
<!--        </a-form-model-item>-->
           ...
           <a-form-model-item label="关联人员" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="personnelId">
                <j-select-personnel v-model="model.personnelId" :multiple="false" :returnId='false'></j-select-personnel>
           </a-form-model-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
          username:[{required: true, message: '请输入登录!'},
          ...
          personnelId: [ { required: true, message: '请选择关联人员' } ]
        },
        departIdShow:false,
        title:"操作",
        visible: false,
